...
export function entityNameTag(entity) {
    if (entity.nameTag == '') {
		switch (entity.typeId) {
			...
			case 'better:warrior':
			case 'better:archer':
				entity.nameTag = villager_names.generateNameMale(entity);
				break;
			case 'better:count':
				entity.nameTag = "Count " + villager_names.generateNameMale(entity) + " of the Castle";
				break;
			case 'better:countman':
				entity.nameTag = "Master " + villager_names.generateNameMale(entity);
				break;
			case 'better:heavy':
				entity.nameTag = "Knight " + villager_names.generateNameMale(entity) + " of the Village";
				break;
  			case 'better:girl_warrior':
 			case 'better:villager_witch':
 			case 'better:archer_female':
  			case 'minecraft:witch':
				entity.nameTag = villager_names.generateNameFemale(entity);
				break;
